...
int main(void) {
  ...
  // draw_board_bitboard(aurora.white_rooks);
  // draw_board_bitboard(aurora.white_queens);
  // draw_board_bitboard(aurora.white_king);
  // draw_board_bitboard(aurora.black_pawns);
  // draw_board_bitboard(aurora.black_knights);
  // draw_board_bitboard(aurora.black_bishops);
  // draw_board_bitboard(aurora.black_rooks);
  // draw_board_bitboard(aurora.black_queens);
  // draw_board_bitboard(aurora.black_king);
  // draw_board_bitboard(aurora.all_white_pieces);
